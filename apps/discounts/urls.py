...
from .views import (
	...
	DiscountRuleViewSet,
	DiscountViewSet,
	FirstOrderDiscountApplyView,
	FirstOrderDiscountView,
)
...
router.register("rules", DiscountRuleViewSet, basename="discount-rule")
router.register("", DiscountViewSet, basename="discount")

urlpatterns = [
	path("coupons/validate/", CouponValidateView.as_view(), name="coupon-validate"),
	path("offers/", ActiveOfferListView.as_view(), name="active-offers"),
